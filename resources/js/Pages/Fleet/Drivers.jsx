                                            ...
                                            <tr key={driver.id} className="hover:bg-slate-50/80 dark:hover:bg-white/[0.02] transition-colors">
                                                ...
                                                <td className="px-5 py-4">
                                                    {active && active.vehicle ? (
                                                        <div className="space-y-1">
                                                            ...
                                                            <div className="flex items-center justify-between gap-3 pt-1 border-t border-slate-100 dark:border-white/[0.04]">
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="px-2.5 py-1 rounded-xl bg-rose-500/10 hover:bg-rose-500 text-rose-600 dark:text-rose-400 hover:text-white border border-rose-500/20 text-[10px] font-extrabold transition-all flex items-center gap-1 shadow-2xs cursor-pointer group shrink-0"
                                                                    title="Zimmeti Sonlandır & Aracı İade Al"
                                                                >
                                                                    <ArrowRightLeft className="w-3 h-3 text-rose-500 group-hover:text-white transition-colors" />
                                                                    <span>İade Al</span>
                                                                </button>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="flex items-center space-x-2">
                                                            <span className="px-2.5 py-1 rounded-xl bg-slate-100 dark:bg-white/[0.04] text-slate-500 dark:text-slate-400 text-[11px] font-bold border border-slate-200/80 dark:border-white/5">
                                                                Boşta / Zimmetsiz
                                                            </span>
                                                            <button
                                                                type="button"
                                                                ...
                                                                className="px-2.5 py-1 rounded-xl bg-blue-500/10 hover:bg-blue-500 text-blue-600 dark:text-blue-400 hover:text-white border border-blue-500/20 text-[10px] font-extrabold transition-all flex items-center gap-1 shadow-2xs cursor-pointer group"
                                                            >
                                                                <Car className="w-3 h-3 text-blue-500 group-hover:text-white" />
                                                                <span>Araç Ata</span>
                                                            </button>
                                                        </div>
                                                    )}
